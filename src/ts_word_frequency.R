...
>>>>>>> d69cf76f4739ede0145c09889a858bc779d38e9f
  }
  ...
  ##### load and process the articles
  article_2020_p_1_td <- read_rds(here::here(
    "output/processed_articles_2020_page_01_EN.rds"
  )) %>%
    tidy_text()
...
<<<<<<< HEAD
ts_word_frequency(
  page_num = 1, start_date = as.Date("2019-01-01"),
